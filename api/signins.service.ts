...
export class SigninsService {
     ...
     */
    public createRegistrationSignin(registrationId: string, idempotencyKey?: string, observe?: 'body', reportProgress?: boolean): Observable<SigninDetailGuest>;
    public createRegistrationSignin(registrationId: string, idempotencyKey?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<SigninDetailGuest>>;
    public createRegistrationSignin(registrationId: string, idempotencyKey?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<SigninDetailGuest>>;
    public createRegistrationSignin(registrationId: string, idempotencyKey?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (registrationId === null || registrationId === undefined) {
            throw new Error('Required parameter registrationId was null or undefined when calling createRegistrationSignin.');
        }
        ...
        return this.httpClient.post<SigninDetailGuest>(`${this.configuration.basePath}/registrations/${encodeURIComponent(String(registrationId))}/signins`,
            null,
            {
