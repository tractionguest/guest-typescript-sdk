 ...
 */
export interface NotificationTrigger1Guest { 
    /**
     * Whether the offset should be calculated as `days` or `hours`
     */
    offsetUnit: NotificationTrigger1Guest.OffsetUnitGuestEnum;
    /**
     ...
     */
    offsetOrigin: NotificationTrigger1Guest.OffsetOriginGuestEnum;
    /**
     ...
     */
    offsetDirection: NotificationTrigger1Guest.OffsetDirectionGuestEnum;
}
export namespace NotificationTrigger1Guest {
